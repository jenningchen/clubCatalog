...
club6 = Club(user_id=1, name="Biomedical Engineering Society",
             description = "The Biomedical Engineering Society serves "\
             "to bring knowledge to its members "\
             "concerning the advancement of biomedical research and "\
             "technology in the medical field. It "\
             "also exists as a forum for discussion among the MIT "\
             "community who would like share ideas or "\
             "opinions. Meetings shall promote interests through "\
...
club7 = Club(user_id=1, name="Undergraduate Economics Association",
             description="The UEA is a group of undergraduates "\
             "interested in economics who meet for the purpose "\
             "of supporting academic endeavors, improving employment "\
             "opportunities, and extending networks with each "\
...
club8 = Club(user_id=11, name = "Eta Kappa Nu, National Electrical "\
             "Engineering and Computer Science Honor Society",
             description = "At MIT, HKN is primarily interested in "\
             "improving course VI by providing students with many "\
             "helpful resources. These resources include the"\
             "Underground guide to course VI and VI-A, the HKN tutoring "\
...
club9 = Club(user_id=1, name="IEEE/ACM Club",
             description="The MIT IEEE/ACM Club represents the student "\
             "branch for two professional international "\
             "organizations, the Institute of Electrical and Electronics "\
             "Engineers (IEEE) and the Association for Computing "\
             "Machinery (ACM). Our mission is to create and support a "\
             "tight-knit community among the students, mainly undergraduates, "\
             "and faculty in the Department of Electrical Engineering and "\
...
club10 = Club(user_id=1, name="MEGAWomen",
              description="MEGAWomen is the association of graduate "\
              "women in the MIT Department of Mechanical Engineering. Our goal "\
              "is to foster life-long friendships, mentor new women students, "\
              "help them lead an enriching graduate school life and assist "\
...
club11 = Club(user_id=1, name="Society of Physics Students",
              description="Whether you spend your spare time reading about "\
              "quantum field theory, or you just think that electromagnetism "\
              "is cool, "\
              "you would fit in at the Society of Physics Students. "\
              "We are open to anyone with an appreciation for physics. "\
              "Whether you have a mild "\
              "curiosity for the science, or an intellectual passion, "\
              "our goal is to make you enjoy physics more.",
...
club12 = Club(user_id=1, name="Pi Tau Sigma, Mechanical Engineering Honory Society",
              description="The object of this organization shall be to encourage "\
              "and recognize superior scholarship, "\
              "to foster the high ideals of the engineering profession, to "\
              "stimulate interest in coordinating departmental "\
              "activities, to promote the mutual professional welfare of "\
              "its members, and to develop in students of mechanical "\
              "engineering the attributes necessary for effective leadership "\
              "and the taking up the responsibilities of a "\
...
club14 = Club(user_id=1, name="Society of Women Engineers",
              description="MIT SWE strives to: -educate members about career "\
              "choices in engineering and promote community between "\
              "professionals and students, including through alumni "\
              "-inspire younger generations about engineering, encourage "\
              "the notion "\
              "of diversity in engineering, and determine and advocate "\
              "for the needs of women engineers at MIT -build community at MIT SWE, "\
              "bridge a relationship with local and national sections, and record "\
              "and disseminate the culture, history, and events of MIT SWE.",
...
club2 = Club(user_id=1, name="Arts at MIT",
             description="The purpose of the MIT Art Club is "\
             "to promote the appreciation "
             "and practice of visual arts at MIT. We hope to provide "\
             "an outlet for any student "\
             "or member of the MIT community to express their "\
             "creativity and explore the arts "\
             "with other people who share this interest. We will "\
             "run activities such as but not "\
             "limited to: Hosting 2 hour meetings every two weeks "\
             "where members can meet to draw, "\
             "paint, and work on art together, Inviting artists, "\
             "lecturers, architects, and designers, "\
             "whether permanent members of the MIT faculty or "\
             "visiting presenters, to give lectures and "\
             "presentations to the club, Studying art history "\
             "and the works of other artists together. We "\
             "will visit the Boston Museum of Fine Arts together "\
             "and other exhibitions throughout Boston, "\
             "Selling our artworks or crafts to raise money for "\
             "charitable groups on campus, Partnering with "\
             "MIT educational organizations to offer art lessons "\
             "to kids who might not otherwise have such "\
             "exposure to art.",
